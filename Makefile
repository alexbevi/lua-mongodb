...
ROCKSPEC := mongodb-0.10.6-1.rockspec
...
.PHONY: check check-fast check-fast-runtime check-full check-tools check-lua check-busted check-luacheck check-luacov check-luarocks check-python \
	...
	test-stress test-compatibility test-compatibility-live test-package test-release-scope test-v04-scope test-v05-scope test-v06-scope test-v07-scope test-v08-scope test-v09-scope test-v10-scope test-v102-scope test-v103-scope test-release-checklist lint rockspec planning-check \
...
test-conformance: check-python test-release-scope test-v04-scope test-v05-scope test-v06-scope test-v07-scope test-v08-scope test-v09-scope test-v10-scope test-v102-scope test-v103-scope test-release-checklist
...
update-spec-artifacts: check-python
...
test-v06-scope: check-python
	@"$(PYTHON)" -m unittest spec.v06.test_scope -v
	@"$(PYTHON)" spec/v06/scope.py --check

test-v07-scope: check-python
	@"$(PYTHON)" -m unittest spec.v07.test_scope -v
	@"$(PYTHON)" spec/v07/scope.py --check
...
test-v10-scope: check-python
	@"$(PYTHON)" -m unittest spec.v10.test_scope -v
	@"$(PYTHON)" spec/v10/scope.py --check

test-v102-scope: check-python
	@"$(PYTHON)" -m unittest spec.v102.test_scope -v
	@"$(PYTHON)" spec/v102/scope.py --check

test-v103-scope: check-python
	@"$(PYTHON)" -m unittest spec.v103.test_scope -v
	@"$(PYTHON)" spec/v103/scope.py --check
