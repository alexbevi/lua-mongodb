...
This prompt is one explicit authorization for the declared `lua-hardening` additional-task track. It does not authorize any `ADV-*`, `AUTH-*`, or other activity outside that track.
