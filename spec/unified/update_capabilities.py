...
OWNER_REASONS = {
  ...
  "CBW-007": "client bulk count batching awaits its dedicated slice",
  "CBW-017": "client bulk message-size batching awaits its dedicated slice",
  "CBW-018": "client bulk batch outcome merging awaits its dedicated slice",
  ...
  "LOG-003": "command redaction awaits its v0.10.4 slice",
  "LOG-004": "command log correlation awaits its v0.10.4 slice",
  "LOG-005": "generic command monitoring awaits its v0.10.4 slice",
  "LOG-006": "insertOne command monitoring awaits its v0.10.4 slice",
  "LOG-007": "collection bulkWrite monitoring awaits its v0.10.4 slice",
  "LOG-010": "handshake command-log suppression awaits its v0.10.4 slice",
  "LOG-011": "heartbeat command-log suppression awaits its v0.10.4 slice",
  "LOG-015": "find command monitoring awaits its v0.10.4 slice",
  "LOG-016": "getMore command monitoring awaits its v0.10.4 slice",
  "LOG-017": "failed find monitoring awaits its v0.10.4 slice",
  "LOG-018": "command-event server connection IDs await their v0.10.4 slice",
  "LOG-019": "insertMany command monitoring awaits its v0.10.4 slice",
  "LOG-020": "deleteOne command monitoring awaits its v0.10.4 slice",
  "LOG-021": "deleteMany command monitoring awaits its v0.10.4 slice",
  "LOG-022": "updateOne command monitoring awaits its v0.10.4 slice",
  "LOG-023": "updateMany command monitoring awaits its v0.10.4 slice",
  "LOG-024": "unacknowledged collection bulk monitoring awaits its v0.10.4 slice",
  "LOG-025": "unacknowledged client bulk monitoring awaits its v0.10.4 slice",
  "LOG-026": "write concern error monitoring awaits its v0.10.4 slice",
...
identity = "crud/tests/unified/client-bulkWrite-errors.json::test[4]"
if identity not in EXECUTOR_TESTS:
  TEST_OVERRIDES[identity] = ("CBW-015", OWNER_REASONS["CBW-015"])
identity = "crud/tests/unified/client-bulkWrite-errors.json::test[6]"
if identity not in EXECUTOR_TESTS:
  TEST_OVERRIDES[identity] = ("CBW-014", OWNER_REASONS["CBW-014"])
identity = "crud/tests/unified/client-bulkWrite-errors.json::test[7]"
TEST_OVERRIDES[identity] = (
  "REL-055",
  None if identity in EXECUTOR_TESTS else OWNER_REASONS["REL-055"],
)
