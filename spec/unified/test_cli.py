...
class UnifiedCliTests(unittest.TestCase):
  def test_first_standalone_insert_one_case_is_runnable(self) -> None:
    ...
    self.assertEqual(1654, manifest["ratchets"]["runnable"])
    self.assertEqual(1654, manifest["ratchets"]["passed"])
  ...
  def test_create_collection_image_case_is_runnable(self) -> None:
    manifest = update_capabilities.generate()
    create = (
    ...
    self.assertNotIn(modify, registry)
