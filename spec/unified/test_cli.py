...
class UnifiedCliTests(unittest.TestCase):
  def test_first_standalone_insert_one_case_is_runnable(self) -> None:
    ...
    self.assertEqual(1450, manifest["ratchets"]["runnable"])
    self.assertEqual(1450, manifest["ratchets"]["passed"])
  ...
  def test_monitor_failure_cases_keep_vertical_slice_owners(self) -> None:
    ...
    self.assertEqual("deferred_unsupported", manifest["tests"][streaming]["status"])
