...
class UnifiedCliTests(unittest.TestCase):
  def test_first_standalone_insert_one_case_is_runnable(self) -> None:
    ...
    self.assertEqual(1768, manifest["ratchets"]["runnable"])
    self.assertEqual(1768, manifest["ratchets"]["passed"])
  ...
  def test_retryable_read_handshake_error_cases_are_runnable(self) -> None:
    ...
    post_v1 = {index: "LEG-006" for index in (7, 8)}
    ...
    identities = {
      ...
      for index in (*applicable, *post_v1, *change_streams)
    }
