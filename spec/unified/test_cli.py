...
class UnifiedCliTests(unittest.TestCase):
  def test_first_standalone_insert_one_case_is_runnable(self) -> None:
    ...
    self.assertEqual(1783, manifest["ratchets"]["runnable"])
    self.assertEqual(1783, manifest["ratchets"]["passed"])
  ...
  def test_command_cursor_release_cases_keep_vertical_slice_owners(self) -> None:
    ...
    post_v1 = {
      ...
      "client-side-operations-timeout/tests/runCursorCommand.json::test[5]": "LEG-009",
