...
class ReleaseChecklistTests(unittest.TestCase):
  ...
  def test_checked_in_release_is_ready(self):
    ...
    self.assertEqual(941, conformance["unsupported_cases"])
    self.assertEqual(
    ...
    self.assertEqual(
      ["ADV-009", "LOG-008", "LOG-009", "LOG-001", "CON-014"],
      report["gates"]["completed_v0_10_3_gates"],
    )
    self.assertEqual(
      {
